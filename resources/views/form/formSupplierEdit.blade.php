                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="nama_lengkap" value="{{$supplier->nama_supplier}}" name="nama_lengkap" class="form-control form-control-alternative" placeholder="masukan nama supplier" required>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      ...
                      <label class="form-control-label" for="input-username">No Telp</label>
                        <input type="number" id="no_telp" value="{{$supplier->no_telp_supplier}}" name="no_telp" class="form-control form-control-alternative" placeholder="No Telp" required>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <textarea id="alamat" name="alamat" class="form-control form-control-alternative" placeholder="Alamat" required>{{$supplier->alamat_supplier}}</textarea>
                      </div>
                    </div>
                  </div>
                  </div>
